...
<h3>Создание темы</h3>
	...
	<hr>
<h3>Создание меню</h3>
	<p>Для создания меню: перейдите в пункт "меню" и заполните необходимые поля. Также любой пункт меню можно при необходимости редактировать или удалять. Вывести меню можно написав на любой странице эту функцию "cms_get_menu();" </p>
	<hr>
...
<hr>
<h3>Пункт меню "Пользователи"</h3>
	<p>Перейдя в данный пункт вы можете изменить логин и пароль администратора сайта</p>
	<hr>
	<h3>Пункт меню "Настройки"</h3>
	<p>Перейдя в данный пункт вы можете изменить заголовок сайта, краткое описание, адрес сайта и email администратора. </p>
	<hr>
